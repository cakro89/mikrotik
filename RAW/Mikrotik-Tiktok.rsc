...
add action=add-dst-to-address-list address-list=Mikrotik-Tiktok address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*tiktok.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP comment="Mikrotik-Tiktok"
