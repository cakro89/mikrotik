##########################
# RAW: Mikrotik-Netflix
##########################
/ip firewall raw
rem [find address-list=Mikrotik-Netflix]
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*netflix.com* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP 
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.netflix.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.nflxvideo.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.nflxext.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Netflix address-list-timeout=1d chain=prerouting protocol=tcp tls-host=*.nflxvideo.* dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
